...
BOOL TMonsterAIElement::LoadData(LPSTR lpszFileName)
{
	...
	TMonsterAIElement::s_MonsterAIMovePath[MAP_INDEX_CRYWOLF_FIRSTZONE].LoadData(gDirPath.GetNewPath(FILE_WORLD_MOVEPATH_CRYWOLF));
	// Double Goer Event
	TMonsterAIElement::s_MonsterAIMovePath[MAP_INDEX_DOUBLEGOER1].LoadData(gDirPath.GetNewPath(FILE_WORLD_MOVEPATH_DOPPEL66));
	TMonsterAIElement::s_MonsterAIMovePath[MAP_INDEX_DOUBLEGOER2].LoadData(gDirPath.GetNewPath(FILE_WORLD_MOVEPATH_DOPPEL67));
	TMonsterAIElement::s_MonsterAIMovePath[MAP_INDEX_DOUBLEGOER3].LoadData(gDirPath.GetNewPath(FILE_WORLD_MOVEPATH_DOPPEL68));
	TMonsterAIElement::s_MonsterAIMovePath[MAP_INDEX_DOUBLEGOER4].LoadData(gDirPath.GetNewPath(FILE_WORLD_MOVEPATH_DOPPEL69));
	return FALSE;
}
...
BOOL TMonsterAIElement::ApplyElementAttackPenetration(int iIndex, int iTargetIndex, TMonsterAIState * pAIState)
{
	...
	TMonsterSkillManager::UseMonsterSkill(iIndex, iTargetIndex, 2,-1, 0);
	return FALSE;
}
...
BOOL TMonsterAIElement::ApplyElementSpecialImmune(int iIndex, int iTargetIndex, TMonsterAIState * pAIState)
{
	...
	gObjAddBuffEffect(lpObj,BUFF_MONSTERMAGIC_RESIST,0,0,0,0,this->m_iX);
	gObjAddBuffEffect(lpObj,BUFF_MONCHEMISTRY_RESIST,0,0,0,0,this->m_iY);
	return FALSE;
}
