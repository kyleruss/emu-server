...
#define MIN_CC_USER_NEED_PLAY	1

#define CHAOS_CASTLE_ZEN_REWARD 0
...
#define CC_MAP_RANGE(x) ( (x == MAP_INDEX_CHAOSCASTLE7) ? TRUE : ( ((x)<MAP_INDEX_CHAOSCASTLE1)?FALSE:((x)>MAP_INDEX_CHAOSCASTLE6)?FALSE:TRUE ))
...

{
	...
	ITEMGET(14,13), 1, ITEMGET(14,14), 2,	// Chaos Castle 7
};
...
public:
	...
	int GetFloor(int MapNumber);
	int GetMap(int iFloorIndex);
