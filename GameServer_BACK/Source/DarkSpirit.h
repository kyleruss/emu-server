...
public:
	...
	float m_iCriticalSuccessRate;	// 14
	float m_iExcelentSuccessRate;	// 18
	int m_iMasterIndex;	// 1C
	int m_iTargetIndex;	// 20
...
public:
  ...
  int GetAttackDamage(LPOBJ lpObj, int targetDefense, int bIsOnDuel,  int criticaldamage,int excellentdamage);
