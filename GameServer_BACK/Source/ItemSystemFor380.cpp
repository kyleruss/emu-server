...
void CItemSystemFor380::_InitOption()
{
	...
	this->m_bSystemFor380ItemOption = GetPrivateProfileInt("GameServerInfo", "System380ItemSystem", 0, gDirPath.GetNewPath(FILE_SERVER_COMMON));
	this->m_iNeedJewelOfHarmonyCount = GetPrivateProfileInt("GameServerInfo", "CountOfJewelOfHarmonyForMix", 1, gDirPath.GetNewPath(FILE_SERVER_COMMON));
	this->m_iNeedJewelOfSuhoCount = GetPrivateProfileInt("GameServerInfo", "CountOfSuhoOfHarmonyForMix", 1, gDirPath.GetNewPath(FILE_SERVER_COMMON));
	this->m_iNeedZenFor380Option = GetPrivateProfileInt("GameServerInfo", "NeedZenForMix", 10000000, gDirPath.GetNewPath(FILE_SERVER_COMMON));
	this->m_iRateSuccessRateForMix1 = GetPrivateProfileInt("GameServerInfo", "MixRateForGrade1", 50, gDirPath.GetNewPath(FILE_SERVER_COMMON));
	this->m_iRateSuccessRateForMix2 = GetPrivateProfileInt("GameServerInfo", "MixRateForGrade2", 60, gDirPath.GetNewPath(FILE_SERVER_COMMON));
	this->m_iRateSuccessRateForMix3 = GetPrivateProfileInt("GameServerInfo", "MixRateForGrade3", 60, gDirPath.GetNewPath(FILE_SERVER_COMMON));
}
...
BOOL CItemSystemFor380::ApplyFor380Option(OBJECTSTRUCT* lpObj)
{
...
void CItemSystemFor380::SetOptionItemByMacro(OBJECTSTRUCT* lpObj, BYTE invenrotyTargetPos, int bOption)
{
	// HERE GOES A MACRO
	return;
	CItem * pItem=NULL;
...
BOOL CItemSystemFor380::ChaosMix380ItemOption(LPOBJ lpObj)
{
	...
	g_ChaosBox.LogChaosItem(lpObj, "380Item][Item Mix");
