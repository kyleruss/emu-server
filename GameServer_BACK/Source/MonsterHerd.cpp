		...
		case 0:
			{
				...
				{
					if ( gObjCheckUsedBuffEffect(lpObj,BUFF_ICEARROW) == FALSE )
					{
...
BOOL MonsterHerd::MonsterRegenAction(LPOBJ lpObj)
{
	...
	gObjRemoveBuffEffect(lpObj,BUFF_STUN);
	gObjRemoveBuffEffect(lpObj,BUFF_COLD);
	gObjRemoveBuffEffect(lpObj,BUFF_FREEZE);
	gObjRemoveBuffEffect(lpObj,BUFF_EARTHBINDS);
