		...
		while ( true )
		{
			...
			while ( true )
			{
				if ( iType == 0 )
				{
					...
					Token = GetToken();
					iAutomata = (int)TokenNumber;

					Token = GetToken();
					iAIClassNormal = (int)TokenNumber;

					Token = GetToken();
					iAIClassMove = (int)TokenNumber;

					Token = GetToken();
					iAIClassAttack = (int)TokenNumber;

					Token = GetToken();
					iAIClassHeal = (int)TokenNumber;

					Token = GetToken();
					iAIClassAvoid = (int)TokenNumber;

					Token = GetToken();
					iAIClassHelp = (int)TokenNumber;

					Token = GetToken();
					iAIClassSpecial = (int)TokenNumber;

					Token = GetToken();
					iAIClassEvent = (int)TokenNumber;
