#if !defined(__MASTERLEVELSKILLTREESYSTEM_H__)
#define __MASTERLEVELSKILLTREESYSTEM_H__
...
public:
	...
	char CheckMasterSkillPoint(int aIndex, int nTreeType);
	char ResetMasterSkill(int aIndex, int nTreeType);
	bool CheckSkillInTree(int iClass, int iSkill, int iTreeKind);
private:
