...
namespace protocol
{
	...
	class MSG_GTOS_USER_CASH_REQ_EX : public MSG_HEADER
	{
	public:
		DWORD dwUserGuid;	// 8	

		MSG_GTOS_USER_CASH_REQ_EX()
		{
			this->size = sizeof(MSG_GTOS_USER_CASH_REQ_EX);
	...
	class MSG_STOG_USER_CASH_ANS_EX : public MSG_HEADER
	{
	public:
		DWORD dwUserGuid;
		DWORD dwUserCash[3];

		MSG_STOG_USER_CASH_ANS_EX()
		{
			this->size = sizeof(MSG_STOG_USER_CASH_ANS_EX);
			this->id = 0x200;
		};
	...
	class MSG_GTOS_ITEM_LIST_REQ_EX : public MSG_HEADER
	{
	public:
		DWORD dwUserGuid;
		DWORD dwPageId;

		MSG_GTOS_ITEM_LIST_REQ_EX()
		{
			this->size = sizeof(MSG_GTOS_ITEM_LIST_REQ_EX);
	...
	class MSG_STOG_ITEM_LIST_ANS_EX : public MSG_HEADER
	{
	public:
		DWORD dwUserGuid;
		DWORD dwPageId;
		...
		MSG_STOG_ITEM_LIST_ANS_EX()
		{
			this->size = sizeof(MSG_STOG_ITEM_LIST_ANS_EX);
			this->id = 0x400;
		};
		...
		void resize()
		{
			this->size = sizeof(MSG_STOG_ITEM_LIST_ANS_EX) - ((9 - this->dwItemCount)*sizeof(productInfoEx));
		};
	};

	class MSG_GTOS_ITEM_USE_REQ_EX : public MSG_HEADER
	{
	public:
		DWORD dwUserGuid;
		DWORD dwItemGuid;
		...
		MSG_GTOS_ITEM_USE_REQ_EX()
		{
			this->size = sizeof(MSG_GTOS_ITEM_USE_REQ_EX);
	...
	class MSG_STOG_ITEM_USE_ANS_EX : public MSG_HEADER
	{
	public:
		DWORD dwUserGuid;
		DWORD dwResult;
		...
		MSG_STOG_ITEM_USE_ANS_EX()
		{
			this->size = sizeof(MSG_STOG_ITEM_USE_ANS_EX);
			this->id = 0x600;
		};
	...
	class MSG_GTOS_GIFT_LIST_REQ_EX : public MSG_HEADER
	{
		public:
		DWORD dwUserGuid;
		DWORD dwPageId;

		MSG_GTOS_GIFT_LIST_REQ_EX()
		{
			this->size = sizeof(MSG_GTOS_GIFT_LIST_REQ_EX);
	...
	class MSG_STOG_GIFT_LIST_ANS_EX : public MSG_HEADER
	{
	public:
		DWORD dwUserGuid;
		DWORD dwPageId;
		...
		MSG_STOG_GIFT_LIST_ANS_EX()
		{
			this->size = sizeof(MSG_STOG_GIFT_LIST_ANS_EX);
			this->id = 0x800;
		};
	...
	class MSG_GTOS_BUY_ITEM_REQ_EX : public MSG_HEADER
	{
	public:
		DWORD dwServerGuid;
		DWORD dwUserGuid;
		...
		MSG_GTOS_BUY_ITEM_REQ_EX()
		{
			this->size = sizeof(MSG_GTOS_BUY_ITEM_REQ_EX);
	...
	class MSG_STOG_BUY_ITEM_ANS_EX : public MSG_HEADER
	{
	public:
		DWORD dwServerGuid;
		DWORD dwUserGuid;
		...
		MSG_STOG_BUY_ITEM_ANS_EX()
		{
			this->size = sizeof(MSG_STOG_BUY_ITEM_ANS_EX);
			this->id = 0xA00;
		};
	...
	class MSG_GTOS_USE_ITEM_NTF_EX : public MSG_HEADER
	{
	public:
		MSG_GTOS_USE_ITEM_NTF_EX()
		{
			this->size = sizeof(MSG_GTOS_USE_ITEM_NTF_EX);
	...
	class MSG_GTOS_GIFT_ITEM_REQ_EX : public MSG_HEADER
	{
	public:
		DWORD dwServerGuid;
		DWORD dwUserGuid;
		...
		MSG_GTOS_GIFT_ITEM_REQ_EX()
		{
			this->size = sizeof(MSG_GTOS_GIFT_ITEM_REQ_EX);
	...
	class MSG_STOG_GIFT_ITEM_ANS_EX : public MSG_HEADER
	{
	public:
		DWORD dwServerGuid;
		DWORD dwUserGuid;
		...
		MSG_STOG_GIFT_ITEM_ANS_EX()
		{
			this->size = sizeof(MSG_STOG_GIFT_ITEM_ANS_EX);
			this->id = 0xE00;
		};
	...
	class MSG_GTOS_UPDATE_POINT_EX : public MSG_HEADER
	{
	public:
		DWORD dwUserGuid;
		DWORD dwAddPoint[3];

		MSG_GTOS_UPDATE_POINT_EX()
		{
			this->size = sizeof(MSG_GTOS_UPDATE_POINT_EX);
...
void SGAndCashItemListEx(int aIndex,protocol::MSG_GTOS_ITEM_LIST_REQ_EX *aRecv);
void SGAnsCashItemUseEx(int aIndex,protocol::MSG_GTOS_ITEM_USE_REQ_EX *aRecv);
void SGAndCashGiftListEx(int aIndex,protocol::MSG_GTOS_GIFT_LIST_REQ_EX *aRecv);
void SGAnsBuyCashItemEx(int aIndex,protocol::MSG_GTOS_BUY_ITEM_REQ_EX *aRecv);
void SGAnsUseCashItemNotifyEx(int aIndex,protocol::MSG_GTOS_USE_ITEM_NTF_EX *aRecv);
void SGAnsGiftCashItemEx(int aIndex,protocol::MSG_GTOS_GIFT_ITEM_REQ_EX *aRecv);
